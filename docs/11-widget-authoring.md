...
디스플레이 내부에는 스크롤을 만들지 않습니다(사용자 지정 2026-09-08). 동적 도판은 `cards/display-viewport.tsx`가 콘텐츠와 판의 크기를 관측해 필요한 경우 축소하며, 확대하지 않습니다. Mark·캡션은 축소 대상이 아닙니다. 입력형 표본의 textarea는 내용에 맞춰 높이를 늘립니다. 페이지 스크롤·캐러셀 넘김·긴 오버레이 캡션의 접근 가능한 스크롤은 별개입니다.
