// 리팩터 이전 가이드라인 블록·Check 스키마의 동결 사본. legacy 컬렉션 전용이며 수정하지 않는다.
...
export function legacyGuidelineChecksField(): Field {
	return {
		name: 'checks',
		type: 'array',
		interfaceName: 'LegacyGuidelineChecks',
		labels: {
			singular: 'Check',
			plural: 'Checks',
		},
...
function baseBlockFields(): Field[] {
	return [legacyGuidelineChecksField()]
}
...
export const LegacyColumnUnitBlock: Block = {
	slug: 'columnUnit',
	interfaceName: 'LegacyColumnUnitBlock',
	fields: [
		{
			name: 'imageRatio',
			type: 'select',
...
export const LegacyMediaShowcaseBlock: Block = {
	slug: 'mediaShowcase',
	interfaceName: 'LegacyMediaShowcaseBlock',
	fields: [
		{
			name: 'imageRatio',
			type: 'select',
...
export const LegacyColorPaletteBlock: Block = {
	slug: 'colorPalette',
	interfaceName: 'LegacyColorPaletteBlock',
	fields: [
...
export const LegacyDoDontBlock: Block = {
	slug: 'doDont',
	interfaceName: 'LegacyDoDontBlock',
	fields: [
		{ name: 'title', type: 'text', localized: true },
		{
			type: 'row',
...
export const legacyGuidelineBlocks = [
	LegacyColumnUnitBlock,
	LegacyMediaShowcaseBlock,
	LegacyColorPaletteBlock,
	LegacyDoDontBlock,
]
