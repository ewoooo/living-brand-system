...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_graphic_profiles_runtime" ADD VALUE 'key-visual-line' BEFORE 'key-visual-pattern';
  ALTER TYPE "public"."enum__graphic_profiles_v_version_runtime" ADD VALUE 'key-visual-line' BEFORE 'key-visual-pattern';`)
}
