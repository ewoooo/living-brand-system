...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_graphic_profiles_runtime" ADD VALUE 'key-visual-formation' BEFORE 'key-visual-line';
  ALTER TYPE "public"."enum__graphic_profiles_v_version_runtime" ADD VALUE 'key-visual-formation' BEFORE 'key-visual-line';`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_graphic_profiles_runtime" AS ENUM('fluted-glass', 'forward-straight', 'key-visual-line', 'key-visual-pattern');
  ...
  CREATE TYPE "public"."enum__graphic_profiles_v_version_runtime" AS ENUM('fluted-glass', 'forward-straight', 'key-visual-line', 'key-visual-pattern');
