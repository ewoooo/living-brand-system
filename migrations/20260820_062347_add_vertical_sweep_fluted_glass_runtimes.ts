...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_graphic_profiles_runtime" ADD VALUE 'sweep-fluted-glass';
  ALTER TYPE "public"."enum_graphic_profiles_runtime" ADD VALUE 'vertical-fluted-glass';
  ALTER TYPE "public"."enum__graphic_profiles_v_version_runtime" ADD VALUE 'sweep-fluted-glass';
  ALTER TYPE "public"."enum__graphic_profiles_v_version_runtime" ADD VALUE 'vertical-fluted-glass';`)
}
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_graphic_profiles_runtime" AS ENUM('forward-straight', 'linear-fluted-glass', 'radial-fluted-glass');
  ...
  CREATE TYPE "public"."enum__graphic_profiles_v_version_runtime" AS ENUM('forward-straight', 'linear-fluted-glass', 'radial-fluted-glass');
