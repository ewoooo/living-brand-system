...
export async function up({ db }: MigrateUpArgs): Promise<void> {
	await db.execute(sql`
		...
		CREATE TABLE "image_profiles_output_allowed_formats" (
			"order" integer NOT NULL,
			"parent_id" integer NOT NULL,
			"value" "enum_image_profiles_output_allowed_formats",
			"id" serial PRIMARY KEY NOT NULL
		);
		CREATE TABLE "_image_profiles_v_version_output_allowed_formats" (
			"order" integer NOT NULL,
			"parent_id" integer NOT NULL,
			"value" "enum__image_profiles_v_version_output_allowed_formats",
			"id" serial PRIMARY KEY NOT NULL
		);
		CREATE TABLE "graphic_profiles_output_allowed_formats" (
			"order" integer NOT NULL,
			"parent_id" integer NOT NULL,
			"value" "enum_graphic_profiles_output_allowed_formats",
			"id" serial PRIMARY KEY NOT NULL
		);
		CREATE TABLE "_graphic_profiles_v_version_output_allowed_formats" (
			"order" integer NOT NULL,
			"parent_id" integer NOT NULL,
			"value" "enum__graphic_profiles_v_version_output_allowed_formats",
			"id" serial PRIMARY KEY NOT NULL
		);
		CREATE TABLE "templates_output_allowed_formats" (
			"order" integer NOT NULL,
			"parent_id" integer NOT NULL,
			"value" "enum_templates_output_allowed_formats",
			"id" serial PRIMARY KEY NOT NULL
		);
		CREATE TABLE "_templates_v_version_output_allowed_formats" (
			"order" integer NOT NULL,
			"parent_id" integer NOT NULL,
			"value" "enum__templates_v_version_output_allowed_formats",
			"id" serial PRIMARY KEY NOT NULL
		);
		...
		ALTER TABLE "graphic_profiles" ADD COLUMN "controller_override" jsonb;
		ALTER TABLE "_graphic_profiles_v" ADD COLUMN "version_controller_override" jsonb;
		ALTER TABLE "templates" ADD COLUMN "controller_override" jsonb;
		ALTER TABLE "_templates_v" ADD COLUMN "version_controller_override" jsonb;
...
export async function down({ db }: MigrateDownArgs): Promise<void> {
	await db.execute(sql`
		DROP TABLE "image_profiles_output_allowed_formats" CASCADE;
		DROP TABLE "_image_profiles_v_version_output_allowed_formats" CASCADE;
		DROP TABLE "graphic_profiles_output_allowed_formats" CASCADE;
		DROP TABLE "_graphic_profiles_v_version_output_allowed_formats" CASCADE;
		DROP TABLE "templates_output_allowed_formats" CASCADE;
		DROP TABLE "_templates_v_version_output_allowed_formats" CASCADE;
		ALTER TABLE "image_profiles" DROP COLUMN "output_original";
		ALTER TABLE "_image_profiles_v" DROP COLUMN "version_output_original";
		ALTER TABLE "graphic_profiles" DROP COLUMN "controller_override";
		ALTER TABLE "_graphic_profiles_v" DROP COLUMN "version_controller_override";
		ALTER TABLE "templates" DROP COLUMN "controller_override";
		ALTER TABLE "_templates_v" DROP COLUMN "version_controller_override";
