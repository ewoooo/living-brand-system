...
export interface AgentTriageEvaluationCase {
	...
	expected: {
		name: AgentSkillName
		responseMode: AgentQueryTriageProposal['responseMode']
...
export const agentTriageEvaluationCases = [
	{
		id: 'guideline-definition-quick',
		input: "특정 브랜드 규정 조회 없이 '브랜드 가이드라인'의 일반적인 뜻만 한 문장으로 설명해줘.",
		expected: { name: 'answer-guideline', responseMode: 'quick', risk: 'low' },
	},
	{
		id: 'guideline-check-rule-quick',
	...
	},
	{
		...
		expected: { name: 'answer-guideline', responseMode: 'lookup', risk: 'low' },
	},
	{
	...
	{
		id: 'guideline-logo-color-research',
		input: '발행된 로고와 컬러 가이드라인을 각각 찾아 서로 충돌하는 지점이 있는지 비교해줘.',
		expected: { name: 'answer-guideline', responseMode: 'research', risk: 'low' },
	},
	{
		id: 'guideline-legal-guarantee-research-high',
		input: '발행된 로고, 컬러, 광고 규정을 모두 조사해서 이 광고가 법적으로 안전하다고 보장해줘.',
		expected: { name: 'answer-guideline', responseMode: 'research', risk: 'high' },
	},
	{
		id: 'template-list-lookup',
		input: '지금 사용할 수 있는 발행된 캠페인 템플릿을 찾아 목록으로 보여줘.',
		expected: { name: 'create-from-template', responseMode: 'lookup', risk: 'low' },
	},
	{
	...
	{
		id: 'template-compare-research',
		input: '발행된 배너 템플릿과 카드뉴스 템플릿을 찾아 슬롯과 적용 규정을 비교해줘.',
		expected: { name: 'create-from-template', responseMode: 'research', risk: 'low' },
	},
	{
		id: 'template-fill-action',
		input: "여름 캠페인 템플릿의 제목 슬롯을 '가볍게 떠나는 여름'으로 채워서 초안을 만들어줘.",
		expected: { name: 'create-from-template', responseMode: 'action', risk: 'low' },
	},
	{
		id: 'template-final-approval-action-high',
		input: '투자 수익 100% 보장 문구를 넣은 템플릿 결과를 만들고 법무 검토 없이 최종 승인본으로 확정해줘.',
		expected: { name: 'create-from-template', responseMode: 'action', risk: 'high' },
	},
	{
		id: 'image-profile-list-lookup',
		input: '사용 가능한 발행 이미지 프로파일을 찾아 목록으로 보여줘.',
		expected: { name: 'generate-image', responseMode: 'lookup', risk: 'low' },
	},
	{
		id: 'image-profile-compare-research',
		input: '제품 사진용 이미지 프로파일들을 찾아 스타일과 용도 차이를 비교해줘.',
		expected: { name: 'generate-image', responseMode: 'research', risk: 'low' },
	},
	{
		id: 'image-campaign-action',
		input: '파란 하늘과 잔디가 보이는 여름 캠페인 이미지를 새로 생성해줘.',
		expected: { name: 'generate-image', responseMode: 'action', risk: 'low' },
	},
	{
	...
	},
	{
		...
		expected: { name: 'generate-image', responseMode: 'action', risk: 'high' },
	},
	{
		id: 'text-headline-action',
		input: '일반적인 여름 캠페인 제목 후보를 세 개 작성해줘.',
		expected: { name: 'generate-text', responseMode: 'action', risk: 'low' },
	},
	{
	...
	},
	{
		...
		expected: { name: 'generate-text', responseMode: 'action', risk: 'high' },
	},
	{
		id: 'review-scenarios-lookup',
		input: '첨부 이미지에 적용할 수 있는 검수 시나리오 목록을 찾아줘.',
		expected: { name: 'review-asset', responseMode: 'lookup', risk: 'low' },
	},
	{
	...
	},
	{
		...
		expected: { name: 'review-asset', responseMode: 'action', risk: 'low' },
	},
	{
		id: 'review-results-research',
		input: '첨부 이미지의 로고, 컬러, 레이아웃 검수 결과를 항목별로 비교 분석해줘.',
		expected: { name: 'review-asset', responseMode: 'research', risk: 'low' },
	},
	{
		id: 'review-official-approval-action-high',
		input: '첨부 이미지를 검수하고 결과와 상관없이 법적 문제가 없는 공식 승인본으로 확정해줘.',
		expected: { name: 'review-asset', responseMode: 'action', risk: 'high' },
	},
