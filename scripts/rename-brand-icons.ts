...
const NAMES = [
	'Clover', 'Blossom', 'Log', 'Shrub', 'Seaweed', 'Sprout', 'Frond', 'Fish',
	'Shell', 'Mushroom', 'Herb', 'Coral', 'Bloom', 'Berry', 'Palm', 'Snail',
	'Grove', 'Hills', 'Gourd', 'Wave', 'Mountain', 'Cloud', 'Sun', 'Moon',
	'Love', 'Joy', 'Serenity', 'Passion',
	'Silk', 'Gloss', 'Velvet', 'Foam',
	'Ampoule', 'Serum', 'Toner', 'Lotion', 'Cream', 'Powder', 'Pump', 'Mist',
]
