...
export function toSweepFlutedGlassInput(values: ControllerValues): SweepFlutedGlassInput {
	return sweepFlutedGlassInputSchema.parse({
		...
		bloomColor: values.bloomColor ?? SWEEP_FLUTED_GLASS_DEFAULT_INPUT.bloomColor,
		rayColor1: values.rayColor1 ?? SWEEP_FLUTED_GLASS_DEFAULT_INPUT.rayColor1,
		rayColor2: values.rayColor2 ?? SWEEP_FLUTED_GLASS_DEFAULT_INPUT.rayColor2,
		rayColor3: values.rayColor3 ?? SWEEP_FLUTED_GLASS_DEFAULT_INPUT.rayColor3,
		rayColor4: values.rayColor4 ?? SWEEP_FLUTED_GLASS_DEFAULT_INPUT.rayColor4,
		rayColor5: values.rayColor5 ?? SWEEP_FLUTED_GLASS_DEFAULT_INPUT.rayColor5,
		rayBackgroundColor:
			values.rayBackgroundColor ?? SWEEP_FLUTED_GLASS_DEFAULT_INPUT.rayBackgroundColor,
