		...
		>
			...
			<div className="rounded-2xl border border-input bg-background p-2 transition-colors focus-within:border-ring focus-within:ring-2 focus-within:ring-ring/30">
				...
				<Textarea
					...
					className="max-h-40 min-h-20 border-0 bg-transparent px-2 py-2 font-body text-sm font-normal shadow-none focus-visible:border-transparent focus-visible:ring-0"
					value={value}
