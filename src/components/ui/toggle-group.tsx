...
function ToggleGroupItem({
	...
	return (
		<ToggleGroupPrimitive.Item
			...
			className={cn(
				// 🔴 spacing 0은 "붙은 한 덩어리"다 — 안쪽 모서리는 각져야 한다. 업스트림은 여기에
				//    rounded-full을 두어 가운데 항목이 알약이 되고 이어진 바에 혹이 생겼다(실측).
				//    바깥 두 끝만 아래 first/last 규칙이 둥글게 만든다. segmented.tsx가 호출부에서
				//    rounded-sm으로 덮어 우회하고 있던 것도 같은 원인이다.
